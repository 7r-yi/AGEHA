...
def maketable_check_input(str):
    ...
    if not str.startswith("自チームのメンバー"):
        ...
        safe = False
        msg = "[]で閉じられていない箇所がある or データ数が足りないかも？＾ｑ＾"

    return safe, msg


def make_table(input):
    source_excel_pass = 'src/clanwar_table.xlsx'
    created_excel_pass = 'src/created_sheet.xlsx'
    pdf_pass = 'src/created_sheet.pdf'
    table_image_pass = 'src/table.png'
    bg_image_pass = 'src/clanwar_table_bg.png'
    created_image_pass = 'src/created_sheet.png'
